document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendarEl = document.getElementById('calendarioPorMes');
        var calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          events: "http://172.16.126.79/sishorarios/index.php?ruta=getAllEventCalendarioPorEspecialidad&txt_id_especialidad="+txt_id_especialidad+"&txt_mes_especialidad="+txt_mes_especialidad,
          ...
          eventClick: function (info) {
            ...
            console.log('fecha start FORMATO:'+moment(eventCalendar.start).format("DD/MM/YYYY HH:mm:ss"));
            console.log('fecha FIN FORMATO:'+eventCalendar.end);
