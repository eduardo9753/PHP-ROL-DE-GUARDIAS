                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="datatable" class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($dataMedicoMesActual as $data) : $i = $i + 1; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="calendarioEstadoMedico" method="POST">
                                                    ...
                                                    <input type="text" value="<?php echo $mesActual ?>" name="txt_mes_actual" id="txt_mes_actual" hidden>
                                                    <input type="submit" class="btn btn-primary" name="btn-horario-medico-mes-actual-registrado" id="btn-horario-medico-mes-actual-registrado" value="Ver">
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
