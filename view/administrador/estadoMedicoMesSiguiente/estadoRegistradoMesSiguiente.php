                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="calendarioEstadoMedico" method="POST">
                                                    ...
                                                    <input type="submit" class="btn btn-primary" name="btn-horario-medico-mes-siguiente-registrado" id="btn-horario-medico-mes-siguiente-registrado" value="Ver">
                                                </form>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
