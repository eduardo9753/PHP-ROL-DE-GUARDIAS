    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <?php include_once('view/administrador/modal/nuevoConsultorio.php'); ?>
            </div>
            <!-- Content Row -->
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="datatable" class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($dataConsultorio as $data) : $i = $i + 1; ?>
                                        <tr>
                                            <th scope="row"><?php echo $i ?></th>
                                            <td><?php echo $data->nombre_consultorio ?></td>
                                            <td>
                                                <?php include('view/administrador/modalEditar/editarConsultorio.php') ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
